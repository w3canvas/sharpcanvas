...
{
    public class DestinationATop : ShaderEffect, ICompositor
    {
        #region Constructors

        static DestinationATop()
        {
            _pixelShader.UriSource = Global.MakePackUri("DestinationATop.ps");
        }

        public DestinationATop()
        {
        ...
        public static readonly DependencyProperty Input1Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input1", typeof(DestinationATop), 0);
        ...
        public static readonly DependencyProperty Input2Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input2", typeof(DestinationATop), 1);
        ...
        public static readonly DependencyProperty ColorFilterProperty =
            DependencyProperty.Register("ColorFilter", typeof(Color), typeof(DestinationATop),
