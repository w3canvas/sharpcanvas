...
{
    public class SourceOut : ShaderEffect, ICompositor
    {
        #region Constructors

        static SourceOut()
        {
            _pixelShader.UriSource = Global.MakePackUri("SourceOut.ps");
        }
        ...
        public static readonly DependencyProperty Input1Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input1", typeof(SourceOut), 0);
        ...
        public static readonly DependencyProperty Input2Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input2", typeof(SourceOut), 1);
        ...
        public static readonly DependencyProperty ColorFilterProperty =
            DependencyProperty.Register("ColorFilter", typeof(Color), typeof(SourceOut),
