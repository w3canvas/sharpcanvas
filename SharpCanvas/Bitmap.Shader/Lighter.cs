...
{
    public class Lighter : ShaderEffect, ICompositor
    {
        #region Constructors

        static Lighter()
        {
            _pixelShader.UriSource = Global.MakePackUri("Lighter.ps");
        }
        ...
        public static readonly DependencyProperty Input1Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input1", typeof(Lighter), 0);
        ...
        public static readonly DependencyProperty Input2Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input2", typeof(Lighter), 1);
        ...
        public static readonly DependencyProperty ColorFilterProperty =
            DependencyProperty.Register("ColorFilter", typeof(Color), typeof(Lighter),
