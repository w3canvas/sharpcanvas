...
{
    public class DestinationOut : ShaderEffect, ICompositor
    {
        #region Constructors

        static DestinationOut()
        {
            _pixelShader.UriSource = Global.MakePackUri("DestinationOut.ps");
        }

        public DestinationOut()
        {
        ...
        public static readonly DependencyProperty Input1Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input1", typeof(DestinationOut), 0);
        ...
        public static readonly DependencyProperty Input2Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input2", typeof(DestinationOut), 1);
        ...
        public static readonly DependencyProperty ColorFilterProperty =
            DependencyProperty.Register("ColorFilter", typeof(Color), typeof(DestinationOut),
