...
{
    public class ChromeSourceIn : ShaderEffect, ICompositor
    {
        #region Constructors

        static ChromeSourceIn()
        {
            _pixelShader.UriSource = Global.MakePackUri("ChromeSourceIn.ps");
        }

        public ChromeSourceIn()
        {
        ...
        public static readonly DependencyProperty Input1Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input1", typeof(ChromeSourceIn), 0);
        ...
        public static readonly DependencyProperty Input2Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input2", typeof(ChromeSourceIn), 1);
        ...
        public static readonly DependencyProperty ColorFilterProperty =
            DependencyProperty.Register("ColorFilter", typeof(Color), typeof(ChromeSourceIn),
