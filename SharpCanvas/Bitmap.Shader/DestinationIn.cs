...
{
    public class DestinationIn : ShaderEffect, ICompositor
    {
        #region Constructors

        static DestinationIn()
        {
            _pixelShader.UriSource = Global.MakePackUri("DestinationIn.ps");
        }

        public DestinationIn()
        {
        ...
        public static readonly DependencyProperty Input1Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input1", typeof(DestinationIn), 0);
        ...
        public static readonly DependencyProperty Input2Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input2", typeof(DestinationIn), 1);
        ...
        public static readonly DependencyProperty ColorFilterProperty =
            DependencyProperty.Register("ColorFilter", typeof(Color), typeof(DestinationIn),
