...
{
    public class XOR : ShaderEffect, ICompositor
    {
        #region Constructors

        static XOR()
        {
            _pixelShader.UriSource = Global.MakePackUri("XOR.ps");
        }
        ...
        public static readonly DependencyProperty Input1Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input1", typeof(XOR), 0);
        ...
        public static readonly DependencyProperty Input2Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input2", typeof(XOR), 1);
        ...
        public static readonly DependencyProperty ColorFilterProperty =
            DependencyProperty.Register("ColorFilter", typeof(Color), typeof(XOR),
