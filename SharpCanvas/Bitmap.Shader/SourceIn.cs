...
{
    public class SourceIn : ShaderEffect, ICompositor
    {
        #region Constructors

        static SourceIn()
        {
            _pixelShader.UriSource = Global.MakePackUri("SourceIn.ps");
        }
        ...
        public static readonly DependencyProperty Input1Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input1", typeof(SourceIn), 0);
        ...
        public static readonly DependencyProperty Input2Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input2", typeof(SourceIn), 1);
        ...
        public static readonly DependencyProperty ColorFilterProperty =
            DependencyProperty.Register("ColorFilter", typeof(Color), typeof(SourceIn),
