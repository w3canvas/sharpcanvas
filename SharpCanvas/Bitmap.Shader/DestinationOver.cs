...
{
    public class DestinationOver : ShaderEffect, ICompositor
    {
        #region Constructors

        static DestinationOver()
        {
            _pixelShader.UriSource = Global.MakePackUri("DestinationOver.ps");
        }

        public DestinationOver()
        {
        ...
        public static readonly DependencyProperty Input1Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input1", typeof(DestinationOver), 0);
        ...
        public static readonly DependencyProperty Input2Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input2", typeof(DestinationOver), 1);
        ...
        public static readonly DependencyProperty ColorFilterProperty =
            DependencyProperty.Register("ColorFilter", typeof(Color), typeof(DestinationOver),
