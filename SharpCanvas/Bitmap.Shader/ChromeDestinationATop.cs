...
{
    public class ChromeDestinationATop : ShaderEffect, ICompositor
    {
        #region Constructors

        static ChromeDestinationATop()
        {
            _pixelShader.UriSource = Global.MakePackUri("ChromeDestinationATop.ps");
        }

        public ChromeDestinationATop()
        {
        ...
        public static readonly DependencyProperty Input1Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input1", typeof(ChromeDestinationATop), 0);
        ...
        public static readonly DependencyProperty Input2Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input2", typeof(ChromeDestinationATop), 1);
        ...
        public static readonly DependencyProperty ColorFilterProperty =
            DependencyProperty.Register("ColorFilter", typeof(Color), typeof(ChromeDestinationATop),
