...
{
    public class SourceATop : ShaderEffect, ICompositor
    {
        #region Constructors

        static SourceATop()
        {
            _pixelShader.UriSource = Global.MakePackUri("SourceATop.ps");
        }
        ...
        public static readonly DependencyProperty Input1Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input1", typeof(SourceATop), 0);
        ...
        public static readonly DependencyProperty Input2Property =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input2", typeof(SourceATop), 1);
        ...
        public static readonly DependencyProperty ColorFilterProperty =
            DependencyProperty.Register("ColorFilter", typeof(Color), typeof(SourceATop),
